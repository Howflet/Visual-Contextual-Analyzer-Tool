chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    if (request.action === "displayResults") {
        ...
        img.onload = () => {
            ...
            chrome.runtime.sendMessage({ action: "callGemini", imageDataUrl: croppedImageDataUrl }, (response) => {
                ...
                if (response.error) {
                    ...
                    // Render text and convert URLs to safe clickable links
    ...
    if (btn) {
        btn.addEventListener('click', () => {
            if (chrome.runtime.openOptionsPage) {
                ...
                // fallback: open options_page directly
